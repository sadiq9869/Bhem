...
bot = telebot.TeleBot('8182447930:AAHVreMejt0Y3mJH1NwcNiopLT4DhMtX0G8')
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  
            ...
            if time > 181:
                ...
                response = f"-漫~*'¨¯¨'*·舞~ 🇮🇳ąɬɬąƈƙ ƈơɱ℘Ɩɛɬɛɖ🇮🇳 ~舞*'¨¯¨'*·~漫- king: {king} @Rohan2349: {soulking} soulking: {time}"
        else:
            response = "✅A͢v͢a͢i͢l͢a͢b͢l͢e͢ r͢i͢g͢h͢t͢ n͢o͢w͢✅ :- /attack  <ip> <port> <time>"  
    else:
        response = " ミ🥹★ 𝘈𝘤𝘤𝘦𝘴𝘴 𝘭𝘦 𝘭𝘦 𝘣𝘳𝘰 ★🥹彡DM - @Rohan2349 ."
...
def welcome_start(message):
    ...
    response = f'''ıllıllı⭐🌟 W͙e͙l͙c͙o͙m͙e͙ t͙o͙ soul family ❣️ 🌟⭐ıllıllı \n {user_name}! \n🄱🄶🄼🄸 🄺🄸 🄶🄰🄽🄳 🄼🄰🅁🄽🄴 🄰🄰 🄶🅈🄴😜
